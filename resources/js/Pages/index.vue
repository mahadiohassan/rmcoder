...
<div class="page-wrapper">
        ...
        <div class="header-upper">
            <div class="auto-container">
				<div class="inner-container d-flex justify-content-between align-items-center flex-wrap">
					<!-- Logo Box -->
					<div class="logo"><a href="index.html"><img src="Frontend/images/logo-2.png" alt="" title=""></a></div>
        ...
        <div class="sticky-header">
            <div class="auto-container">
				<div class="d-flex justify-content-between align-items-center">
					<!-- Logo -->
					<div class="logo">
						<a href="index.html" title=""><img src="Frontend/images/logo.png" alt="" title=""></a>
					</div>
						...
						<div class="content-inner">
							...
							<div class="lower-box">
								...
								<div class="post-block">
									<div class="inner-box">
										<div class="image">
											<img src="Frontend/images/resource/post-thumb-1.jpg" alt="" />
										</div>
								...
								<div class="post-block">
									<div class="inner-box">
										<div class="image">
											<img src="Frontend/images/resource/post-thumb-2.jpg" alt="" />
										</div>
								...
								<div class="post-block">
									<div class="inner-box">
										<div class="image">
											<img src="Frontend/images/resource/post-thumb-3.jpg" alt="" />
										</div>
	...
	<section class="banner-one">
		...
		<div class="auto-container">
			<div class="banner-one_shadow-layer" style="background-image:url(Frontend/images/background/pattern-27.png)"></div>
			<div class="banner-one_icons" data-parallax='{"y" : -150}' style="background-image:url(Frontend/images/icons/banner-icons.png)"></div>
			<div class="banner-one_circles" style="background-image:url(Frontend/images/background/pattern-28.png)"></div>
			<!-- Content Column -->
			...
			<div class="parallax-scene-1">
				<div class="banner-one_image" data-depth="0.15">
					<img src="Frontend/images/resource/banner.png" alt="" />
				</div>
			</div>
		</div>
	</section>
	...
	<section class="company-one">
		<div class="company-one_shadow" style="background-image:url(Frontend/images/background/pattern-29.png)"></div>
		<div class="auto-container">
			<!-- Sec Title Three -->
			...
			<div class="row clearfix">
				...
				<div class="company-one_block col-lg-4 col-md-6 col-sm-12">
					<div class="company-one_block_inner" style="background-image:url(Frontend/images/background/pattern-30.png)">
						<div class="company-one_block_icon"><img src="Frontend/images/icons/service-12.png" alt="" /></div>
						...
						<div class="company-one_block_overlay" style="background-image:url(Frontend/images/background/pattern-31.png)">
							<div class="company-one_block_icon"><img src="Frontend/images/icons/service-12.png" alt="" /></div>
							<h5 class="company-one_block_heading">Technical Support</h5>
				...
				<div class="company-one_block active col-lg-4 col-md-6 col-sm-12">
					<div class="company-one_block_inner" style="background-image:url(Frontend/images/background/pattern-30.png)">
						<div class="company-one_block_icon"><img src="Frontend/images/icons/service-13.png" alt="" /></div>
				...
				<div class="company-one_block col-lg-4 col-md-6 col-sm-12">
					<div class="company-one_block_inner" style="background-image:url(Frontend/images/background/pattern-30.png)">
						<div class="company-one_block_icon"><img src="Frontend/images/icons/service-14.png" alt="" /></div>
				...
				<div class="company-two_content-column col-lg-6 col-md-12 col-sm-12">
					<div class="company-two_content-inner wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="company-two_image">
							<img src="Frontend/images/resource/company.png" alt="" />
						</div>
					</div>
				</div>
			</div>
	...
	<section class="about-three">
		<div class="about-three_shadow" style="background-image:url(Frontend/images/background/pattern-32.png)"></div>
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="about-three_content-column col-lg-6 col-md-12 col-sm-12">
					<div class="about-three_content-inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="about-three_image">
							<img src="Frontend/images/resource/about-3.png" alt="" />
						</div>
					</div>
				</div>
	...
	<section class="counter-three">
		<div class="auto-container">
			<div class="counter-three_inner-container">
				<div class="counter-three_pattern-one" style="background-image:url(Frontend/images/background/pattern-33.png)"></div>
				<div class="counter-three_pattern-two" style="background-image:url(Frontend/images/background/pattern-34.png)"></div>
				...
				<div class="row clearfix">
					...
					<div class="counter-three_block col-lg-4 col-md-6 col-sm-6">
						<div class="counter-three_block-inner">
							<span class="counter-three_counter-icon"><img src="Frontend/images/icons/counter-1.png" alt="" /></span>
					...
					<div class="counter-three_block col-lg-4 col-md-6 col-sm-6">
						<div class="counter-three_block-inner">
							<span class="counter-three_counter-icon"><img src="Frontend/images/icons/counter-2.png" alt="" /></span>
					...
					<div class="counter-three_block col-lg-4 col-md-6 col-sm-6">
						<div class="counter-three_block-inner">
							<span class="counter-three_counter-icon"><img src="Frontend/images/icons/counter-3.png" alt="" /></span>
	...
	<section class="steps-one">
		<div class="steps-one_shadow" style="background-image:url(Frontend/images/background/pattern-35.png)"></div>
		<div class="steps-one_shadow-two" style="background-image:url(Frontend/images/background/pattern-36.png)"></div>
		<div class="auto-container">
			<!-- Sec Title Three -->
			<div class="sec-title_three centered">
							...
							<div class="step-block_one-number-column col-lg-6 col-md-12 col-sm-12">
								<div class="step-block_one-number-inner">
									<div class="d-flex step-block_one-number-content">
										...
										<span class="step-one_icon"><img src="Frontend/images/icons/step-1.png" alt="" /></span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="step-block_one-number-column col-lg-6 col-md-12 col-sm-12">
								<div class="step-block_one-number-inner">
									<div class="d-flex step-block_one-number-content">
										...
										<span class="step-one_icon"><img src="Frontend/images/icons/step-2.png" alt="" /></span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="step-block_one-number-column col-lg-6 col-md-12 col-sm-12">
								<div class="step-block_one-number-inner">
									<div class="d-flex step-block_one-number-content">
										...
										<span class="step-one_icon"><img src="Frontend/images/icons/step-3.png" alt="" /></span>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="services-carousel owl-carousel owl-theme">
				...
				<div class="service-block_four">
					<div class="service-block_four-inner">
						<span class="service-block_four-icon"><img src="Frontend/images/icons/service-15.png" alt="" /></span>
				...
				<div class="service-block_four">
					<div class="service-block_four-inner">
						<span class="service-block_four-icon"><img src="Frontend/images/icons/service-16.png" alt="" /></span>
				...
				<div class="service-block_four">
					<div class="service-block_four-inner">
						<span class="service-block_four-icon"><img src="Frontend/images/icons/service-17.png" alt="" /></span>
	...
	<!-- Testimonial Section -->
	<section class="testimonial-section-two" style="background-image: url(Frontend/images/background/map.png)">
		<div class="testimonial-section-two_shadow" style="background-image:url(Frontend/images/background/pattern-35.png)"></div>
		<div class="testimonial-section-two_shadow-two" style="background-image:url(Frontend/images/background/pattern-35.png)"></div>
		<div class="auto-container">
			<div class="side-image">
				<img src="Frontend/images/resource/testimonial.png" alt="" />
			</div>
	...
	<section class="clients-two wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
		<div class="auto-container">
			<div class="clients-two_inner-container" style="background-image: url(Frontend/images/background/pattern-37.png)">
				<h2 class="clients-two_title">Our Trusted <span>Partners</span></h2>
				
				<!-- Sponsors Carousel -->
				<ul class="sponsors-carousel owl-carousel owl-theme">
					<li class="slide-item"><figure class="client-one_image-box-two"><a href="#"><img src="Frontend/images/clients/9.png" alt=""></a></figure></li>
					<li class="slide-item"><figure class="client-one_image-box-two"><a href="#"><img src="Frontend/images/clients/10.png" alt=""></a></figure></li>
					<li class="slide-item"><figure class="client-one_image-box-two"><a href="#"><img src="Frontend/images/clients/11.png" alt=""></a></figure></li>
					<li class="slide-item"><figure class="client-one_image-box-two"><a href="#"><img src="Frontend/images/clients/12.png" alt=""></a></figure></li>
					<li class="slide-item"><figure class="client-one_image-box-two"><a href="#"><img src="Frontend/images/clients/13.png" alt=""></a></figure></li>
					<li class="slide-item"><figure class="client-one_image-box-two"><a href="#"><img src="Frontend/images/clients/14.png" alt=""></a></figure></li>
					<li class="slide-item"><figure class="client-one_image-box-two"><a href="#"><img src="Frontend/images/clients/9.png" alt=""></a></figure></li>
					<li class="slide-item"><figure class="client-one_image-box-two"><a href="#"><img src="Frontend/images/clients/10.png" alt=""></a></figure></li>
					<li class="slide-item"><figure class="client-one_image-box-two"><a href="#"><img src="Frontend/images/clients/11.png" alt=""></a></figure></li>
					<li class="slide-item"><figure class="client-one_image-box-two"><a href="#"><img src="Frontend/images/clients/12.png" alt=""></a></figure></li>
